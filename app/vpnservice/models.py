...
class UserSiteModel(models.Model):
    site_name = models.SlugField(max_length=45, verbose_name='site_name', unique=True)
...
class SiteInfoModel(models.Model):
    data_sent = models.IntegerField(verbose_name='data_sent', null=True, blank=True)
    data_loaded = models.IntegerField(verbose_name='data_loaded', null=True, blank=True)
